		...
		<div class="relative z-20 mt-auto max-w-lg" in:fly={{ x: -20, duration: 1000, delay: 400 }}>
			...
			<blockquote class="space-y-6">
				...
				<footer class="flex items-center gap-4">
					<div
						class="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-700 bg-zinc-800 text-xs font-bold text-zinc-400"
					>
						PP
					</div>
					<div>
						<p class="font-bold text-white">PiedPipers</p>
						<p class="text-sm text-zinc-500">Decentralized Protocol Team</p>
					</div>
				</footer>
			</blockquote>
		</div>
